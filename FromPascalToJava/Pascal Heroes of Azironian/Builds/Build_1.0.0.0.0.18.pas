...
//Использованные модули:
  ...
  //7. Кнопки:
  btnLocMch, btnOffLocMch, btnOnLocMch: PictureABC;
...
devSpotlight := Picture.Create('DEV_Spotlight.png');
 ...
 //Установка шрифта и цвета для написания текста:
  ...
  btnLocMch := PictureABC.Create(0, 0, 'ButtonOffMenuLocMatch.png');
  //Пока не нажали кнопку:
