...
//Использованные модули:
  ...
  headlinePict, dpsPict, healthPict, dpsDevPict, dpsLVPict, dpsBHRPict,
  healthDevPict, healthLVPict, healthBHRPict: Picture;
  //2. Системные переменные:
  var fragOffset: integer;
  //3. Текстовые переменные:
  var turnOfFstPlayer, turnOfScdPlayer: textabc;
  //4. Строки:
  var bonusStrBuilder: string;
  //5. Массив бонусов:
  var bonusesArr: array [1..16] of PictureABC;
  //6. Таймер:
  var timer := new Timer(100, TimerProc);
...
devSpotlight := Picture.Create('DEV_Spotlight.png');
 ...
 headlinePict := PictureABC.Create(-10000, -10000, 'Headline.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 headlinePict.Scale(windowwidth / headline.Width*951/2223);
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
  //Инициализация возможностей героев:
 dpsPict := PictureABC.Create(-10000, -10000, 'dpsHero.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 healthPict := PictureABC.Create(-10000, -10000, 'healthHero.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 dpsDevPict := PictureABC.Create(-10000, -10000, 'DmgSkillDev.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 healthDevPict := PictureABC.Create(-10000, -10000, 'HealthDevSkill.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 dpsLVPict := PictureABC.Create(-10000, -10000, 'DmgSkillLV.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 healthLVPict := PictureABC.Create(-10000, -10000, 'HealthLVSkill.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 dpsBHRPict := PictureABC.Create(-10000, -10000, 'DmgSkillBHR.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 healthBHRPict := PictureABC.Create(-10000, -10000, 'HealthBHRSkill.png');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 ...
 loadWindow := PictureABC.Create(-10000, -10000, 'Gates_Background.jpg');
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 loadWindow.Scalex := (windowwidth / 4335);
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
  fragOffset,trunc(52/1434* windowheight));fragOffset := fragOffset + trunc(523 / 2223 * windowWidth / 50);
 loadWindow.Scaley := (windowheight / 3270);
  loadFrag.Draw(trunc(844/2223* windowWidth),trunc(1234/1434* windowheight),
 ...
 //Установка шрифта и цвета для написания текста:
  ...
  Sleep(2000);
  initWindow.draw(0, 0, windowWidth, windowHeight);
  headlinePict.MoveTo((windowWidth-headline.Width)div 2, (windowheight - headline.Height) div 2);
  timer.Start;
  Sleep(2000);
