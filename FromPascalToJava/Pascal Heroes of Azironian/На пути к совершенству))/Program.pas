...
//  if (x >= trunc(windowWidth div 9 * 7.93)) and (y <= trunc(windowHeight div 10)) then
//  begin
//  btnOnExitLocMch.MoveTo(trunc(windowWidth div 9 * 7.93) , trunc(windowHeight div 80));
...
//Установка шрифта и цвета для написания текста:
  ...
  btnOffExitLocMch.Scale(0.35);
  btnOffExitLocMch := PictureABC.Create(-10000, -10000, 'ButtonExitOnWindowLocMatchOnTwo.png');
  btnOnExitLocMch.Scale(0.35);
