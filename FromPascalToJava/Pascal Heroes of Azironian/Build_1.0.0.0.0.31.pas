...
//Использованные модули:
  Timers, ABCObjects, GraphABC, ABCSprites, System.Media, System.Windows, System, System.Net, System.Threading.Tasks;
  ...
  menuChoice: byte;
  //2.1 Триггеры:
  var triggerInGame, boolLocTime : boolean;
 ...
 begin
 while boolLocTime = true do 
 begin
 Font.Size := 20;
    var t := DateTime.Now;
    var s := string.Format('{0:d2}:{1:d2}',t.Hour,t.Minute);
    var outTime := new TextABC(WindowWidth * 90 div 95, WindowHeight * 20 div 21, 25, s, clwhite);
    Sleep(1000);
    outTime.Destroy();
 end;
  end;
...
begin
  ...
  //8.0 Курсор:
  procedure MouseCursor(x, y, mb: integer);
  begin
  if (mb = 0) then Cursor.MoveTo(x, y);
  end;
...
//Main////////////////////////////////////////////////////////////////////////
  ...
  begin
//  if boolLocTime = true then ProcLocalTime;
